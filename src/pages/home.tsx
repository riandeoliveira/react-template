  ...
  return (
    <>
      <div className="flex justify-center p-8">
        <div className="w-6xl flex flex-col gap-8 rounded-2xl border-2 border-card-border p-6">
          <h1 className="text-4xl font-semibold">Basic Components</h1>
          <div className="flex flex-col gap-6">
            <h2 className="text-3xl font-semibold border-b border-card-border pb-2">
              Button
            </h2>
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                <Card className="max-w-96 flex flex-col gap-2 rounded-tl-none">
                  ...
                  <p className="text-muted">{t("card_description")}</p>
                </Card>
              </div>
            </div>
          </div>
