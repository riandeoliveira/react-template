  ...
  return (
    <>
      <div className="flex justify-center p-8">
        <div className="w-6xl flex flex-col gap-8 rounded-2xl border-2 border-zinc-300 dark:border-zinc-700 p-6">
          <h1 className="text-4xl font-semibold">Basic Components</h1>
          <div className="flex flex-col gap-6">
            <h2 className="text-3xl font-semibold border-b border-zinc-300 dark:border-zinc-700 pb-2">
              Button
            </h2>
